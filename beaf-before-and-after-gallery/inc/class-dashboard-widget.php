...
class BeafDashboardWidget {
    ...
    public function beaf_register_dashboard_widget() {
        wp_add_dashboard_widget( 'beaf_widget', __( 'BEAF Overview', 'beaf-before-and-after-gallery' ), array( $this, 'beaf_display_dashboard_widget' ) , null, null, 'normal', 'high' );
    }
        ...
        <div class="beaf-widget">
            ...
            <div class="beaf-stats">
                <div class="beaf-stat">
                    ...
                    <span><?php esc_html_e( 'Total Sliders', 'beaf-before-and-after-gallery' ); ?></span>
                </div>
            ...
            <div class="beaf-actions">
                <a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=bafg' ) ); ?>" class="button button-primary">
                    <?php esc_html_e( 'Create Slider', 'beaf-before-and-after-gallery' ); ?>
                </a>
                <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=bafg&page=bafg_gallery' ) ); ?>" class="button">
                    <?php esc_html_e( 'Gallery Generator', 'beaf-before-and-after-gallery' ); ?>
                </a>
                <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=bafg&page=beaf_settings' ) ); ?>" class="button">
                    <?php esc_html_e( 'BEAF Settings', 'beaf-before-and-after-gallery' ); ?>
                </a>
            </div>
            
            <!-- Popular Integrations -->
            <div class="beaf-section beaf-integrations">
                <h4><?php esc_html_e( 'Popular Features', 'beaf-before-and-after-gallery' ); ?></h4>
                ...
                <div class="beaf-integration-grid">
                    <div class="beaf-integration-item">
                        ...
                        <span><?php esc_html_e( 'Horizontal/Vertical Slider', 'beaf-before-and-after-gallery' ); ?></span>
                    </div>
                    ...
                    <div class="beaf-integration-item">
                        ...
                        <span><?php esc_html_e( 'Multi-column Gallery', 'beaf-before-and-after-gallery' ); ?></span>
                    </div>
                    ...
                    <div class="beaf-integration-item">
                        ...
                        <span><?php esc_html_e( 'Hover / Drag Interaction', 'beaf-before-and-after-gallery' ); ?></span>
                    </div>
                    ...
                    <div class="beaf-integration-item">
                        ...
                        <span><?php esc_html_e( 'Page Builder Support', 'beaf-before-and-after-gallery' ); ?></span>
                    </div>
            ...
            <div class="beaf-actions">
                <a href="<?php echo esc_url( 'https://themefic.com/plugins/beaf/' ); ?>" target="_blank" class="button">
                    <?php esc_html_e( 'Check More Features', 'beaf-before-and-after-gallery' ); ?>
                </a>
            </div>
            ...
            <div class="beaf-upsell">
                <h4><?php esc_html_e( 'Unlock Pro Features', 'beaf-before-and-after-gallery' ); ?></h4>
                <ul>
                    <li><?php esc_html_e( '✔ 10+ Preview Styles', 'beaf-before-and-after-gallery' ); ?></li>
                    <li><?php esc_html_e( '✔ Video Slider', 'beaf-before-and-after-gallery' ); ?></li>
                    <li><?php esc_html_e( '✔ 3 Image Comparison', 'beaf-before-and-after-gallery' ); ?></li>
                    <li><?php esc_html_e( '✔ Filterable Gallery', 'beaf-before-and-after-gallery' ); ?></li>
                </ul>
                <a href="<?php echo esc_url( 'https://themefic.com/plugins/beaf/pro/pricing/' ); ?>" target="_blank" class="button button-primary go-pro">
                    <?php esc_html_e( 'Upgrade Now', 'beaf-before-and-after-gallery' ); ?>
                </a>
            </div>
            <?php } ?>

            <!-- Blog Section -->
			<div class="beaf-section-title"><?php esc_html_e( 'Latest posts from BEAF', 'beaf-before-and-after-gallery' ); ?></div>
			<ul class="beaf-blog-list">
				<li>
					<span class="beaf-badge"><?php esc_html_e( 'NEW', 'beaf-before-and-after-gallery' ); ?></span>
					<a href="<?php echo esc_url( 'https://themefic.com/introducing-beaf-4-6-2-improved-performance-and-new-features/' ); ?>" target="_blank"><?php esc_html_e( 'Introducing BEAF 4.6.2: Improved Performance and New Features', 'beaf-before-and-after-gallery' ); ?></a>
				</li>
				<li>
					<a href="<?php echo esc_url( 'https://themefic.com/before-after-slider-all-the-amazing-features-but-now-with-video/' ); ?>" target="_blank"><?php esc_html_e( 'Before After Slider: All the Amazing Features, But Now with Video', 'beaf-before-and-after-gallery' ); ?></a>
				</li>
			</ul>
            ...
            <div class="beaf-footer">
                <a href="<?php echo esc_url( 'https://themefic.com/docs/beaf' ); ?>" target="_blank">
                    <?php esc_html_e( 'Docs', 'beaf-before-and-after-gallery' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
                <a href="<?php echo esc_url( 'https://portal.themefic.com/support/' ); ?>" target="_blank">
                    <?php esc_html_e( 'Support', 'beaf-before-and-after-gallery' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
                <a href="<?php echo esc_url( 'https://themefic.com/blog/' ); ?>" target="_blank">
                    <?php esc_html_e( 'Blog', 'beaf-before-and-after-gallery' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
