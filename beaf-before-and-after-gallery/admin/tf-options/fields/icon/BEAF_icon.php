...
if ( ! class_exists( 'BEAF_icon' ) ) {
	class BEAF_icon extends BEAF_Fields {
		...
		public function render() {
			...
			?>
						<div class="tf-icon-select" id="tf-icon-<?php echo esc_attr( $this->field['id'] . $uniqueid ); ?>">
							...
							<a href="#" class="tf-admin-btn tf-modal-btn"><i class="ri-add-fill"></i><?php esc_html_e( 'Add Icon', 'beaf-before-and-after-gallery' ); ?></a>
								...
								<div class="container tf-modal-content">
									<div class="tf-modal-header">
										<div class="tf-icon-search">
											<input type="text" placeholder="<?php esc_html_e( 'Search', 'beaf-before-and-after-gallery' ); ?>" class="tf-icon-search-input"/>
										</div>
									...
									<div class="tf-modal-footer">
										<a class="tf-icon-insert tf-admin-btn tf-btn-secondary disabled"><?php esc_html_e( 'Insert', 'beaf-before-and-after-gallery' ); ?></a>
									</div>
								</div>
							</div>
						</div>
		...
		public function get_icon_list() {
			$icons = array(
				'fontawesome_4' => array(
					'label' => __( 'Font Awesome 4', 'beaf-before-and-after-gallery' ),
					'label_icon' => 'fa-regular fa-font-awesome',
					'icons' => $this->fontawesome_four_icons(),
				),
				'fontawesome_5' => array(
					'label' => __( 'Font Awesome 5', 'beaf-before-and-after-gallery' ),
					'label_icon' => 'fa-regular fa-font-awesome',
					'icons' => $this->fontawesome_five_icons(),
				),
				'fontawesome_6' => array(
					'label' => __( 'Font Awesome 6', 'beaf-before-and-after-gallery' ),
					'label_icon' => 'fa-regular fa-font-awesome',
					'icons' => $this->fontawesome_six_icons(),
				),
				'remixicon' => array(
					'label' => __( 'Remix Icon', 'beaf-before-and-after-gallery' ),
